...
トップページで一番伝えたいことはアプリの説明なので、アニメーションもで最小限に抑えました。
 
また3色に統一することによって、ユーザーが見やすいページを目指しました。
...
![非同期コメント投稿画面](https://i.gyazo.com/5262dfa533cd6aae199a0f170c1faaa3.gif)
 
コメント機能は非同期通信で実装致しました。
(ユーザー目線で使用感を確かめた時、同期より非同期通信の方が使用しやすいと感じた為。)
